...
const Hero = () => {
  return (
    <>
      <Nav /> 
      <section className="flex justify-between lg:flex-row flex-col-reverse bg-medium text-sec bg-primary lg:pt-[-5rem] pt-[5rem]" id="home">
        <div className="lg:w-2/4  w-full lg:px-16 px-8">
            <div className="flex flex-col items-center lg:gap-6 gap-2">
                <h1 className="lg:text-6xl text-2xl text-center lg:py-16 py-5">EMPOWERING SMES THROUGH THE PROVISIONS OF QUICK <b>LOANS </b></h1>
